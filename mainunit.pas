...
uses
	...
	ComCtrls, Menus, StdCtrls, ToolWin, ExtCtrls, Buttons, ImgList, enigmaunit,
	shellapi,
	System.ImageList;
...
type
    ...
    panelReel4: TPanel;
		...
		procedure Rotor4UpDownChangingEx(Sender: TObject; var AllowChange: Boolean;
			NewValue: Integer; Direction: TUpDownDirection);
    procedure EnigmaPageControlChange(Sender: TObject);
	private
...
begin
	...
	if FourRotorsRadioButton.Checked = True then
	begin
...
procedure TMainForm.EnigmaPageControlChange(Sender: TObject);
begin
  UseSettings;
end;
...
begin
	case C of
		'A':
			ShowLightImage(ALight, 0);
		'B':
			ShowLightImage(BLight, 1);
		'C':
			ShowLightImage(CLight, 2);
		'D':
			ShowLightImage(DLight, 3);
		'E':
			ShowLightImage(ELight, 4);
		'F':
			ShowLightImage(FLight, 5);
		'G':
			ShowLightImage(GLight, 6);
		'H':
			ShowLightImage(HLight, 7);
		'I':
			ShowLightImage(ILight, 8);
		'J':
			ShowLightImage(JLight, 9);
		'K':
			ShowLightImage(KLight, 10);
		'L':
			ShowLightImage(LLight, 11);
		'M':
			ShowLightImage(MLight, 12);
		'N':
			ShowLightImage(NLight, 13);
		'O':
			ShowLightImage(OLight, 14);
		'P':
			ShowLightImage(PLight, 15);
		'Q':
			ShowLightImage(QLight, 16);
		'R':
			ShowLightImage(RLight, 17);
		'S':
			ShowLightImage(SLight, 18);
		'T':
			ShowLightImage(TLight, 19);
		'U':
			ShowLightImage(ULight, 20);
		'V':
			ShowLightImage(VLight, 21);
		'W':
			ShowLightImage(WLight, 22);
		'X':
			ShowLightImage(XLight, 23);
		'Y':
			ShowLightImage(YLight, 24);
		'Z':
			ShowLightImage(ZLight, 25);
	end;
end;
...
begin
	case C of
		'A':
			ShowDarkImage(ALight, 0);
		'B':
			ShowDarkImage(BLight, 1);
		'C':
			ShowDarkImage(CLight, 2);
		'D':
			ShowDarkImage(DLight, 3);
		'E':
			ShowDarkImage(ELight, 4);
		'F':
			ShowDarkImage(FLight, 5);
		'G':
			ShowDarkImage(GLight, 6);
		'H':
			ShowDarkImage(HLight, 7);
		'I':
			ShowDarkImage(ILight, 8);
		'J':
			ShowDarkImage(JLight, 9);
		'K':
			ShowDarkImage(KLight, 10);
		'L':
			ShowDarkImage(LLight, 11);
		'M':
			ShowDarkImage(MLight, 12);
		'N':
			ShowDarkImage(NLight, 13);
		'O':
			ShowDarkImage(OLight, 14);
		'P':
			ShowDarkImage(PLight, 15);
		'Q':
			ShowDarkImage(QLight, 16);
		'R':
			ShowDarkImage(RLight, 17);
		'S':
			ShowDarkImage(SLight, 18);
		'T':
			ShowDarkImage(TLight, 19);
		'U':
			ShowDarkImage(ULight, 20);
		'V':
			ShowDarkImage(VLight, 21);
		'W':
			ShowDarkImage(WLight, 22);
		'X':
			ShowDarkImage(XLight, 23);
		'Y':
			ShowDarkImage(YLight, 24);
		'Z':
			ShowDarkImage(ZLight, 25);
	end;
end;
...
procedure TMainForm.UseSettings;
begin
	if ThreeRotorsRadioButton.Checked = True then
	begin
		EnigmaMachine.RotorCount := rc3;
		PanelReel4.Visible := False;

		if ReflectorBRadioButton.Checked = True then
			EnigmaMachine.Reflector.Reflectortype := refNormalB
		else if ReflectorCRadioButton.Checked = True then
			EnigmaMachine.Reflector.Reflectortype := refNormalC;
	end
	else
	begin
		PanelReel4.Visible := True;

		EnigmaMachine.RotorCount := rc4;
		if ReflectorBRadioButton.Checked = True then
			EnigmaMachine.Reflector.Reflectortype := refThinB
		else if ReflectorCRadioButton.Checked = True then
			EnigmaMachine.Reflector.Reflectortype := refThinC;
		if BetaRadioButton.Checked = True then
			EnigmaMachine.Rotor4.RotorType := rtBeta
		else if GammaRadioButton.Checked = True then
			EnigmaMachine.Rotor4.RotorType := rtGamma;
	end;
	case Rotor1ComboBox.ItemIndex of
		0:
			EnigmaMachine.Rotor1.RotorType := rt1;
		1:
			EnigmaMachine.Rotor1.RotorType := rt2;
		2:
			EnigmaMachine.Rotor1.RotorType := rt3;
		3:
			EnigmaMachine.Rotor1.RotorType := rt4;
		4:
			EnigmaMachine.Rotor1.RotorType := rt5;
		5:
			EnigmaMachine.Rotor1.RotorType := rt6;
		6:
			EnigmaMachine.Rotor1.RotorType := rt7;
		7:
			EnigmaMachine.Rotor1.RotorType := rt8;
	end;
	case Rotor2ComboBox.ItemIndex of
		0:
			EnigmaMachine.Rotor2.RotorType := rt1;
		1:
			EnigmaMachine.Rotor2.RotorType := rt2;
		2:
			EnigmaMachine.Rotor2.RotorType := rt3;
		3:
			EnigmaMachine.Rotor2.RotorType := rt4;
		4:
			EnigmaMachine.Rotor2.RotorType := rt5;
		5:
			EnigmaMachine.Rotor2.RotorType := rt6;
		6:
			EnigmaMachine.Rotor2.RotorType := rt7;
		7:
			EnigmaMachine.Rotor2.RotorType := rt8;
	end;
	case Rotor3ComboBox.ItemIndex of
		0:
			EnigmaMachine.Rotor3.RotorType := rt1;
		1:
			EnigmaMachine.Rotor3.RotorType := rt2;
		2:
			EnigmaMachine.Rotor3.RotorType := rt3;
		3:
			EnigmaMachine.Rotor3.RotorType := rt4;
		4:
			EnigmaMachine.Rotor3.RotorType := rt5;
		5:
			EnigmaMachine.Rotor3.RotorType := rt6;
		6:
			EnigmaMachine.Rotor3.RotorType := rt7;
		7:
			EnigmaMachine.Rotor3.RotorType := rt8;
	end;
	var s := '';
	for var i := 0 to PlugBoardMemo.Lines.Count - 1 do
	begin
		if Length(PlugBoardMemo.Lines[i]) = 2 then
			s := s + ' ' + PlugBoardMemo.Lines[i]
		else
...
begin
	case Direction of
		updUP:
			if Rotor4Edit.Text[1] = 'Z' then
				Rotor4Edit.Text := 'A'
			else
				Rotor4Edit.Text := chr(ord(Rotor4Edit.Text[1]) + 1);

		updDOWN:
			if Rotor4Edit.Text[1] = 'A' then
				Rotor4Edit.Text := 'Z'
			else
				Rotor4Edit.Text := chr(ord(Rotor4Edit.Text[1]) - 1)
	end;
...
begin
	ShellExecute(Application.Handle, '', 'Enigma.chm', '',
